        ...
        <form method="POST" action="{{ route('products.update' , $product) }}" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="nombre"
                    ...
                    placeholder="nombre..." name="nombre" value="{{old('nombre' , $product -> nombre)}}">
                @error('nombre')
                    <x-inputserror>
                            {{$message}}
                    </x-inputserror>
            ...
            <div class="mb-5">
                ...
                <textarea type="text" id="descripcion"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="descripcion..." name="descripcion">{{old('descripcion' , $product -> descripcion)}}</textarea>
            ...
            <div class="mb-5">
                ...
                <input type="number" value="{{old('precio' , $product -> precio)}}"   id="precio" step="0.01" placeholder="Ingrese el precio (hasta 2 decimales)"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="precio">
            </div>
            @error('precio')
            ...
            <div class="mb-5">
                ...
                <input type="number" value="{{old('stock' , $product -> stock)}}" id="stock" step="0.01" placeholder="Cantidad de stock"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="stock">
            </div>
            @error('stock')
                ...
                <div class="flex w-full">
                    <div class="w-1/2 mr-2">
                        <label for="imagen"  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Imagen</label>
                        <input type="file" value="{{old('imagen') , $product -> imagen}}" id="imagen" oninput="img.src=window.URL.createObjectURL(this.files[0])"
